...
//GetPath.getBasePath()
	...
	public void initiate() throws IOException, AWTException, ATUTestRecorderException {	
		...
		System.out.println("Read browser type "+browser);
		if (browser.equalsIgnoreCase("firefox")) {
			System.out.println("Inside ff 1");
			...
			//driver=new RemoteWebDriver(new URL("http://172.31.64.1:4445/wd/hub"),cap);
			//driver=new RemoteWebDriver(new URL("http://"+currentIp+":4444/wd/hub"),cap);
			//driver=new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"),cap);
			System.out.println("Inside ff 2");
			//driver=new RemoteWebDriver(new URL("http://localhost:4445/wd/hub"),cap);
			System.out.println("http://"+currentIp+":4444/wd/hub");
			driver=new RemoteWebDriver(new URL("http://"+currentIp+":4444/wd/hub"),cap);
			//127.0.1.1
			//driver=new RemoteWebDriver(new URL("http://127.0.1.1:4445/wd/hub"),cap);

			System.out.println("Insode ff 3");
